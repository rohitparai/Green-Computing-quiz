...
public class ModerateOrHardLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moderate_or_hard_quiz);
        ...
        findViewById(R.id.btnNextQUESTIONeasyANDhard).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (btnNext.getText().equals(getString(R.string.next))){
                    ...
                    Intent intentResult = new Intent(ModerateOrHardLevel.this,FinalResultActivity.class);
        ...
        findViewById(R.id.imageViewStartQuizModerateOrHard).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
